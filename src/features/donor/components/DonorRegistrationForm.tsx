...
import { BloodType, DonorProfileFormData } from '../types';
...
const DonorRegistrationForm: React.FC<DonorRegistrationFormProps> = ({
  ...
  const { createDonorProfile, isLoading } = useDonorProfile();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onError?.(error instanceof Error ? error : new Error('Failed to create donor profile'));
    }
  };
